  ...
  return docInfo && (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        <div>
          <img src={docInfo.image} alt="" className='bg-gradient-to-b from-blue-100 to-green-50 w-full sm:max-w-72 rounded-lg' />
        </div>
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          {/* doctor name, degree, experince  */}
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointment} className='bg-blue-900 w-1/2 text-white text-sm font-light px-14 py-3 rounded-full my-6 cursor-pointer'>
          Book an appointment
        </button>
      </div>
