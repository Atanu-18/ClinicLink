...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-gradient-to-r from-[#0ea5e9] to-[#22c55e] rounded-lg px-6 md:px-10 lg:px-20'>
      {/* left side */}
      ...
      <div className='md:w-1/2 relative'>
        <img src={assets.header_img} alt="" className='w-ful md:absolute bottom-0 h-auto rounded-lg'/>
      </div>
    </div>
  )
}
